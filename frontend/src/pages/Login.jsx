...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center p-6 bg-slate-950 overflow-y-auto">
      ...
      <div className="glow-blob w-[500px] h-[500px] bg-brand-600 top-[-10%] left-[-10%] animate-pulse-slow"></div>
      <div className="glow-blob w-[400px] h-[400px] bg-violet-600 bottom-[-10%] right-[-10%] animate-pulse-slow" style={{ animationDelay: '-3s' }}></div>
      ...
      <div className="w-full max-w-md z-10 flex-1 flex flex-col justify-center my-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">
            Sign in to manage your career search
          </p>
        </div>
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/60 border border-slate-800 rounded-xl py-3 pl-11 pr-4 text-sm text-slate-200 placeholder-slate-500 outline-none transition-all duration-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20"
          ...
          <div className="mt-8 text-center text-xs text-slate-400">
            ...
            <Link to="/signup" className="text-brand-400 hover:text-brand-300 font-semibold transition-colors duration-150">
              Sign up
            </Link>
          </div>
        </div>
